        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('drills.store') }}">
                            @csrf
...
{{--                                               name="problem{{ $i - 1 }}" value="{{ old('problem'.($i - 1)) }}" autocomplete="problem{{ $i - 1 }}" autofocus>--}}
{{--                                        @error('problem'.($i - 1))--}}
{{--                                        <span class="invalid-feedback" role="alert">--}}
{{--                        <strong>{{ $message }}</strong>--}}
{{--                      </span>--}}
